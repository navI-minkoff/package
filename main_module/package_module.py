    ...
    try:
        with Session(action="open", file_path=source_psd_path,
            ...
            packingLists(ps, doc, jpeg_options, lists_jpeg[0]['lists_folder_path'],
                         ...
                         extractNumber(getFileWithDefiniteEnding(
                             sorted(getJpegFilenames(output_path), key=extractNumber),
            ...
            all_filenames_in_output_path = sorted(getJpegFilenames(output_path), key=extractNumber),
